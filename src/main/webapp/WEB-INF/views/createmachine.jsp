...
<div>
	...
	<form:form action="${pageContext.request.contextPath}/createMachine" method="post" id="createMachine" class="border" modelAttribute="may">
	...
	<div class="text-danger ml-3">${message}</div>
		<div class="d-flex flex-column pl-3 pr-3 text-secondary">
			<div class="form-group">
				...
				<form:input path="maMay" class="form-control" id="maMay"/>
