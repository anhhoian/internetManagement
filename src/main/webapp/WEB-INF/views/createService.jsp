...
<div>
	...
	<form:form action="${pageContext.request.contextPath}/createService" method="post" id="createService" class="border" modelAttribute="dichVu">
		<p class="form-header pl-3 pr-3 mb-3">Thêm dịch vụ mới</p>
	<div class="text-danger ml-3">${message }</div>
		<div class="d-flex flex-column pl-3 pr-3 text-secondary">
			<div class="form-group">
				...
				<form:input path="maDichVu" class="form-control" id="maDichVu"/>
