...
<body>
<div>
	<p class="title-content mt-3 mb-2">Sửa Khách Hàng</p>
	<form:form action="${pageContext.request.contextPath}/updateCustom" method="post" id="createCustomer" class="border" modelAttribute="khach">
	<div class="text-danger ml-3">${message }</div>
		<div class="d-flex flex-column pl-3 pr-3 text-secondary">
			<div class="form-group">
				<label>Mã khách hàng</label>: <span>${khach.maKH}</span>
				<form:input path="maKH" class="form-control d-none" id="maKH"/>
